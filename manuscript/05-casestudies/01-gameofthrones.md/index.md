...
```
    ...
    <networkx.classes.graph.Graph at 0x7f722a1e3ee0>
...
```
    ...
    [('Eddard-Stark', 0.045520792228306656),
     ...
     ('Catelyn-Stark', 0.030193105286631935),
     ('Robert-Baratheon', 0.029834742227736723),
     ('Jon-Snow', 0.026834499522066214),
     ('Robb-Stark', 0.021562941297247517),
     ('Sansa-Stark', 0.02000803404286464),
     ('Bran-Stark', 0.019945786786238328),
     ('Jaime-Lannister', 0.01750784720284688),
     ('Cersei-Lannister', 0.01708260458475807)]
...
```
    ...
    [('Eddard-Stark', 0.07239401100498243),
     ('Robert-Baratheon', 0.048517275705099366),
     ('Jon-Snow', 0.047706890624749115),
     ('Tyrion-Lannister', 0.043674378927062885),
     ('Catelyn-Stark', 0.03466703470130741),
     ('Bran-Stark', 0.029774200539800188),
     ('Robb-Stark', 0.02921618364519687),
     ('Daenerys-Targaryen', 0.02708962251302111),
     ('Sansa-Stark', 0.02696177891568311),
     ('Cersei-Lannister', 0.021631679397418953)]
